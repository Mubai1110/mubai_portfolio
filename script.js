...
const translations = {
  en: {
    ...
    'exp.cc.company': "Empyrean Global Investments (Dreame Technology's CVC)",
    ...
    'proj.oasyce.desc': 'Identified and directly connected with a seed-stage social + world model application through proprietary university and founder networks. Conducted industry research on world models, AI hardware, and authentic social interaction.',
  ...
  zh: {
    ...
    'exp.present': '至今',
    'exp.cc.role': '投资分析师',
    'exp.cc.company': '天空工厂创投 / Empyrean Global Investments（追觅科技 CVC）',
    'exp.cc.rmb': 'AI 赛道覆盖',
    ...
    'proj.title': '关注领域',
    'proj.featured': '项目负责人',
    'proj.oasyce.desc': '通过高校与创业者网络转化对接的种子轮水下项目，聚焦社交 x 世界模型应用。围绕世界模型、AI 硬件与真实社交展开行业研究。',
