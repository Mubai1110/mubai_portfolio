...
const translations = {
  en: {
    ...
    'hero.desc': 'B.B.A. & M.Sc. Finance at <strong>CUHK</strong>. Investment analyst with hands-on experience across RMB & USD VC funds. Deeply passionate about <strong>AI</strong> and frontier tech investing. Driven by curiosity, committed to long-termism.',
    ...
    'exp.cc.company': 'Chase Chuang VC & Empyrean VC',
    'exp.cc.rmb': 'RMB VC Fund',
    'exp.cc.rmb.items': '<li>Led or supported end-to-end investment processes for <strong>5 projects</strong> — Pre-IPO metal 3D printing, Series A pool-cleaning robotics, Series A humanoid robotics, angel-stage window-cleaning robotics (Dreame ecosystem), and autonomous logistics vehicles</li><li>Assisted portfolio companies in government investment attraction — site selection, agreement drafting, cross-party coordination</li>',
    'exp.cc.usd': 'USD AI & Robotics VC Fund',
    'exp.cc.usd.items': '<li>Led bilingual fundraising materials — pitch decks, one-pagers, deal pipelines</li><li>Sourced <strong>100+ institutional LPs</strong> via Pitchbook/Preqin across HK, Singapore, Middle East & Europe</li><li>Sourced a European distributor group with <strong>USD 1M committed intent</strong>; led dedicated fund roadshows</li>',
    ...
    'proj.physical.title': 'AI Investment Track',
    'proj.physical.desc': 'Hands-on investment experience across the AI value chain — humanoid robots, cleaning robots (floor/window/pool), industrial robots, plus upstream components (LiDAR, gearbox, motors).',
    ...
    'proj.intel.desc': 'A daily AI industry knowledge base tracking products, infrastructure, models, funding, key people, and frontier applications.',
  ...
  zh: {
    ...
    'hero.desc': '<strong>香港中文大学</strong>金融学本硕。横跨人民币与美元VC基金的投资分析师。专注<strong>AI</strong>及前沿科技投资。好奇心驱动，坚信长期主义。',
    'hero.viewwork': '查看经历',
    ...
    'exp.present': '至今',
    'exp.cc.role': '投资分析师',
    'exp.cc.company': '追创创业投资 & Empyrean VC',
    'exp.cc.rmb': '人民币VC基金',
    'exp.cc.rmb.items': '<li>主导或协助完成<strong>5个项目</strong>全流程——Pre-IPO金属3D打印、A轮泳池清洁机器人、A轮人形机器人、天使轮擦窗清洁机器人（追觅生态）、无人物流车</li><li>协助被投企业招商引资——选址勘探、协议起草、多方协调</li>',
    'exp.cc.usd': '美元AI&机器人VC基金',
    'exp.cc.usd.items': '<li>主导双语募资材料——路演演示、单页摘要、项目管线</li><li>通过数据平台触达<strong>100+机构LP</strong>，覆盖港新/中东/欧洲</li><li>挖掘一家东欧经销商集团，对方意向出资<strong>100万美元</strong>；主导基金路演</li>',
    'exp.qa.role': 'PE投资助理',
    ...
    'exp.dc.items': '<li><strong>并购策略：</strong>提出"收购壳公司+注入资产+总部搬迁返投"退出策略——被合伙人采纳，公司据此成立并购小组</li><li><strong>数字化建设：</strong>主导OA系统优化，节省2-3个人力工作量</li><li>独立完成中基协/保协/政基系统<strong>30+基金</strong>信息披露</li>',
    'proj.title': '关注领域',
    'proj.featured': '项目负责人',
    'proj.oasyce.desc': '主导世界模型社交平台绿洲的尽调与战略研究。对AI硬件与"真实社交"趋势展开行业分析。利用个人资源对接前海母基金、达晨财智等机构。',
    'proj.physical.title': 'AI 投资赛道',
    'proj.physical.desc': '横跨AI产业链的实操投资经验——人形机器人、清洁机器人（扫地/擦窗/泳池）、工业机器人，以及上游组件（激光雷达、齿轮箱、电机）。',
    'proj.lowalt.title': '低空经济',
    'proj.lowalt.desc': '深度参与低空产业链全流程——整机制造、飞控航电、通信系统、数据采集环节的项目研究与执行。',
    'proj.intel.title': 'AI 每日情报库',
    'proj.intel.desc': '每日沉淀 AI 赛道关键信号，覆盖产品、Infra、模型、融资、关键人物与前沿应用。',
    'tag.humanoid': '人形机器人',
    'tag.cleaning': '清洁机器人',
...
const knowledgeBase = {
  ...
  thesis: {
    ...
    en: "Mubai's investment thesis focuses on AI. He maps opportunities using a 2x2 matrix of application maturity × technology maturity: Blue Ocean (immature app + mature tech, like window-cleaning robots) is the sweet spot. He sees 80%+ domestic capital from SOEs reshaping GP strategies, and believes USD funds face headwinds but offer unique cross-border opportunities.",
    zh: "慕白的投资框架聚焦AI。他用「应用成熟度 × 技术成熟度」的2x2矩阵来定位机会：蓝海（未成熟应用+成熟技术，如擦窗机器人）是投资甜蜜点。他观察到国内80%+资金来自国资LP，深刻影响GP策略；美元基金承压但存在跨境机遇。"
  },
  physical_ai: {
    keywords: ['ai', 'robot', 'robotics', 'humanoid', 'cleaning', 'lidar', '机器人', '人形', '清洁', '激光雷达'],
    en: "Mubai focuses on AI because he's seen the entire value chain up close — from humanoid robots and cleaning robots (floor/window/pool) to upstream components like LiDAR, gearboxes, and motors. He classifies investment scenarios into red ocean (mature tech + mature app), blue ocean (mature tech + immature app — the sweet spot), early stage, and frontier. His hands-on DD experience gives him real conviction in this space.",
    zh: "慕白关注AI因为他实地接触了整条产业链——从人形机器人、清洁机器人（扫地/擦窗/泳池）到上游的激光雷达、齿轮箱、电机。他把投资场景分为红海、蓝海（甜蜜点）、早期和前沿四类。实地尽调经验让他对这个赛道有真正的认知深度。"
  },
  skills: {
